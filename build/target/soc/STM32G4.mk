...
# SoC specifics --- port
#######################################
ifeq ($(TARGET_SOC),STM32G431xx)
DEVICE_DEFS :=
LD_SCRIPT = $(FINNAV_TARGET_LINKER_DIR)/STM32G431K6Ux_FLASH.ld
STARTUP_FILE = startup_stm32g431xx.s
CONFIG_MCU_FLASH_SIZE ?= 128
else ifeq ($(TARGET_SOC),STM32G474xx)
DEVICE_DEFS :=
LD_SCRIPT = $(FINNAV_TARGET_LINKER_DIR)/STM32G474VETx_FLASH.ld #TODO
STARTUP_FILE = startup_stm32g474xx.s
CONFIG_MCU_FLASH_SIZE ?= 512
else
$(call ERROR,FinNAV,Unknown MCU for STM32G4 target.)
endif
