...
DEVICE_DEFS += -DARM_MATH_CM7 -DARM_MATH_MATRIX_CHECK -DARM_MATH_ROUNDING -DUNALIGNED_SUPPORT_DISABLE
endif
...
EXCLUDE_FILE := \
$(SOC_PERIPHERAL_LIB_DIR)/stm32h7xx_hal_timebase_rtc_wakeup_template.c \
$(SOC_PERIPHERAL_LIB_DIR)/stm32h7xx_hal_timebase_rtc_alarm_template.c
